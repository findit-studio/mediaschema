...
fn main() -> Result<(), Box<dyn std::error::Error>> {
    ...
    println!("media doc keys  = {:?}", media_doc.keys().collect::<Vec<_>>());
    println!("audio doc keys  = {:?}", audio_doc.keys().collect::<Vec<_>>());
    println!("track doc keys  = {:?}", track_doc.keys().collect::<Vec<_>>());
