...
// (no PgSubtitleCueRowRef — borrowed views for the polymorphic base /
// detail rows are a follow-up; promote `PgSubtitleCueBaseRow` / the
// detail rows directly for now.)
