...
CREATE TABLE IF NOT EXISTS audio_track (
    ...
    ced_provenance_model_name     VARCHAR(255) NOT NULL,
    ced_provenance_model_version  VARCHAR(255) NOT NULL,
    ced_provenance_prompt_version VARCHAR(255) NOT NULL,
    ced_provenance_indexer_version VARCHAR(255) NOT NULL,
