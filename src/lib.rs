...
pub use generated::media::v1::{
  ...
  ListLocationsRequest, ListLocationsResponse, Local, Location, LocationTarget, Media, MediaFile,
  ...
  Point2D, Provenance, RemoveLocationRequest, RemoveLocationResponse, Request, RequestEnvelope,
  Response, ResponseEnvelope, RetryFailedRequest, RetryFailedResponse, SaliencyRegion, Scene,
  SceneMeta, SceneVlmResult, SearchFilter, SearchHit, SearchRequest, SearchResponse, SoundSource,
  ...
  TrackClassificationType, TrackRecord, TrackTag, TrackTime, TrackTimeSource,
  UpdateAnnotationRequest, UpdateAnnotationResponse, Video, VideoFormat, VideoMeta,
  VideoStreamMeta, VideoTrack, VideoTrackMeta, VoiceFingerprint, Volume, VolumeMeta,
